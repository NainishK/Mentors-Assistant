<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExcelDemo.aspx.cs" Inherits="aspx_ExcelDemo" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4" style="background: linear-gradient(to right, #b51a0c, #61045f);">
                <div class="row">
                    <div class=" text-center display-4">Sessional Report</div>
                </div>
                <br />
                <form id="form1" runat="server">
                    <div>
                        ...
                        <asp:SqlDataSource ID="ExcelDemoDataSrc" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select p.Surname, p.FirstName, p.MiddleName, s.Sem, s.Subject, s.Test1, s.Test2 from tblSessional as s, tblPersonalDetails as p where p.Email=s.Email order by p.Surname, s.Sem;"></asp:SqlDataSource>
