<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoStudentsMsg.aspx.cs" Inherits="aspx_NoStudentsMsg" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark black" style="background-color: #373e49">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../aspx/SignOut.aspx">SignOut</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="background: linear-gradient(to right, #b51a0c, #61045f);">
                ...
                <form id="form1" runat="server">
                    <div>
                        <h3 style="text-align:center">No students under you, have yet registered!</h3>
                    </div>
                </form>
                <div class="col-sm-4"></div>
