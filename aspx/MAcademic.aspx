<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MAcademic.aspx.cs" Inherits="aspx_MPersonal" %>
                    ...
                    <div>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="ExcelDemoDataSrc" ForeColor="Black" GridLines="Vertical">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NoOfKTs" HeaderText="NoOfKTs" SortExpression="NoOfKTs" />
                                <asp:BoundField DataField="KtSubjects" HeaderText="KtSubjects" SortExpression="KtSubjects" />
                                <asp:BoundField DataField="SGPI" HeaderText="SGPI" SortExpression="SGPI" />
                            </Columns>
                        ...
                        <asp:SqlDataSource ID="ExcelDemoDataSrc" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Surname, FirstName, MiddleName, Sem, Result, NoOfKTs, KtSubjects, SGPI FROM tblPersonalDetails as p, tblAdmin2 as m, tblAcademicRecords as r where p.Year=m.Year and p.Batch=m.Batch and m.Mentor=@email and p.Email=r.Email order by RollNo;">
                            <SelectParameters>
